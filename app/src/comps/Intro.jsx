...
export default function Intro(){
    ...
    return (
        <div className='w-[100%] h-[100vh] sm:h-[100vh] bg-gradient-to-t from-violet-900 from-0% via-slate-950 via-15% to-yellow-700 to-[92%]'>
            
            <div className='max-w-[90%] sm:max-w-[90%] h-[75vh] sm:h-[75vh] w-full mx-auto pt-[14vh]  z-0 '>
                <div style={{backgroundImage: `url(${slides[slideIndex].url})`}} className='w-full h-full bg-center bg-cover rounded-3xl duration-500 border-4 border-yellow-700/90 shadow-md shadow-yellow-700 origin-left'>
                </div>
