...
function Nav(){
    ...
    return (
        ...
        <div className="w-full sm:w-screen sm:h-[5rem] bg-slate-900 text-slate-200 text-lg  sm:text-lg ">
            ...
            {((windowSize<=668)&&(navBtn))?<button className='my-4' onClick={() => {
            ...
            {(windowSize<=668)?<div ref={slideMenu} className='fixed w-0 h-[100vh] bg-slate-900/90 flex-col place-items-center justify-center tracking-[1px] py-40  text-2xl origin-left duration-500 '  >
